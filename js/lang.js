...
async function getLanguageFile(lang) {
    const response = await fetch(`/${repoName}/locales/${lang}.json`); // Le mot-clé "await" est utilisé pour les tâches qui prennent du temps. On attend d'abord qu'elle se conclut.
